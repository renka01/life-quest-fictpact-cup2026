          ...
          return (
            <button 
              ...
              className={`flex items-center gap-4 px-4 py-3 rounded-md transition-all group ${
                isActive ? 'bg-cyan-500/10 text-cyan-400 border border-cyan-500/30' : 'text-slate-500 hover:bg-slate-900 hover:text-slate-300'
              }`}
            >
              <item.icon size={20} className={isActive ? 'drop-shadow-[0_0_5px_rgba(34,211,238,0.8)]' : ''} />
