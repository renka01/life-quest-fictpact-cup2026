...
const TurtleGiIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="13" y="8" width="6" height="4" fill="#1e3a8a"/>
    <rect x="10" y="20" width="12" height="4" fill="#1e3a8a"/>
    <rect x="8" y="10" width="2" height="6" fill="#ea580c"/>
    <rect x="22" y="10" width="2" height="6" fill="#ea580c"/>
    <rect x="18" y="12" width="3" height="3" fill="#fef08a"/>
  </svg>
);

const SurveyCorpsIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="8" width="10" height="16" fill="#f8fafc"/>
    <rect x="10" y="8" width="12" height="8" fill="#78350f"/>
    <rect x="13" y="8" width="6" height="8" fill="#f8fafc"/>
    <rect x="10" y="20" width="12" height="2" fill="#451a03"/>
    <rect x="8" y="10" width="2" height="10" fill="#78350f"/>
    <rect x="22" y="10" width="2" height="10" fill="#78350f"/>
    <rect x="11" y="14" width="1" height="8" fill="#0f172a"/>
...
const AkatsukiIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="8" width="12" height="18" fill="#0f172a"/>
    <rect x="8" y="10" width="16" height="14" fill="#0f172a"/>
    <rect x="12" y="8" width="8" height="2" fill="#dc2626"/>
    <rect x="13" y="14" width="3" height="2" fill="#dc2626"/>
    <rect x="18" y="20" width="3" height="2" fill="#dc2626"/>
    <rect x="12" y="14" width="1" height="1" fill="#f8fafc"/>
...
const IronArmorIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="8" width="12" height="16" fill="#dc2626"/>
    <rect x="12" y="10" width="8" height="12" fill="#b91c1c"/>
    <rect x="8" y="10" width="2" height="14" fill="#dc2626"/>
    <rect x="22" y="10" width="2" height="14" fill="#dc2626"/>
    <rect x="14" y="12" width="4" height="4" fill="#22d3ee"/>
    <rect x="15" y="13" width="2" height="2" fill="#f8fafc"/>
    <rect x="11" y="18" width="2" height="6" fill="#fbbf24"/>
...
const N7SuitIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="8" width="12" height="16" fill="#1e293b"/>
    <rect x="12" y="10" width="8" height="12" fill="#334155"/>
    <rect x="18" y="10" width="2" height="14" fill="#dc2626"/>
    <rect x="20" y="10" width="1" height="14" fill="#f8fafc"/>
    <rect x="8" y="10" width="2" height="14" fill="#1e293b"/>
    <rect x="22" y="10" width="2" height="14" fill="#1e293b"/>
    <rect x="13" y="12" width="6" height="4" fill="#0f172a"/>
  </svg>
);

const DemonSlayerIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="8" width="10" height="16" fill="#0f172a"/>
    <rect x="14" y="10" width="1" height="10" fill="#94a3b8"/>
    <rect x="11" y="18" width="10" height="2" fill="#f8fafc"/>
    <rect x="8" y="10" width="4" height="12" fill="#166534"/>
    <rect x="20" y="10" width="4" height="12" fill="#166534"/> 
    <rect x="8" y="12" width="4" height="2" fill="#0f172a"/>
...
const JediRobeIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="8" width="12" height="18" fill="#d6d3d1"/>
    <rect x="14" y="8" width="4" height="6" fill="#a8a29e"/>
    <rect x="10" y="18" width="12" height="3" fill="#451a03"/>
    <rect x="15" y="18" width="2" height="3" fill="#94a3b8"/>
    <rect x="7" y="10" width="3" height="12" fill="#78350f"/>
...
const HevSuitIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="8" width="12" height="16" fill="#0f172a"/>
    <rect x="11" y="10" width="10" height="8" fill="#f97316"/>
    <rect x="14" y="12" width="4" height="4" fill="#fbbf24"/>
    <rect x="15" y="13" width="2" height="2" fill="#1e293b"/>
    <rect x="11" y="20" width="10" height="4" fill="#f97316"/>
    <rect x="8" y="10" width="2" height="6" fill="#f97316"/>
    <rect x="22" y="10" width="2" height="6" fill="#f97316"/>
    <rect x="8" y="16" width="2" height="8" fill="#0f172a"/>
...
const IronHelmIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="8" width="10" height="12" fill="#dc2626"/>
    <rect x="13" y="10" width="6" height="8" fill="#fbbf24"/>
    <rect x="14" y="12" width="1" height="1" fill="#22d3ee"/>
    <rect x="17" y="12" width="1" height="1" fill="#22d3ee"/>
  </svg>
);

const StrawHatIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="12" width="12" height="4" fill="#fde047"/>
    <rect x="8" y="16" width="16" height="2" fill="#fde047"/>
...
const HiddenLeafIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="12" width="12" height="4" fill="#1e293b"/>
    <rect x="12" y="13" width="8" height="2" fill="#94a3b8"/>
...
const InosukeHelmIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="8" width="12" height="12" fill="#a8a29e"/>
    <rect x="13" y="14" width="2" height="2" fill="#334155"/>
    <rect x="11" y="11" width="2" height="2" fill="#38bdf8"/>
    <rect x="19" y="11" width="2" height="2" fill="#38bdf8"/>
    <rect x="11" y="6" width="2" height="3" fill="#fb7185"/>
    <rect x="19" y="6" width="2" height="3" fill="#fb7185"/>
  </svg>
);

const VaderHelmIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="8" width="10" height="12" fill="#0f172a"/>
...
const SpartanHelmIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="10" width="10" height="10" fill="#1e293b"/>
    <rect x="12" y="12" width="8" height="4" fill="#fbbf24"/>
    <rect x="13" y="13" width="6" height="1" fill="#22d3ee" opacity="0.6"/>
  </svg>
);

const SaitamaBaldIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="10" width="10" height="10" fill="#ffdbac" rx="5"/>
...
const HollowMaskIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="11" y="8" width="10" height="12" fill="#f8fafc"/>
...
const GordonGlassesIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="12" y="13" width="3" height="2" fill="#000"/>
    <rect x="17" y="13" width="3" height="2" fill="#000"/>
...
const SurveyCapeIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="10" y="8" width="12" height="14" fill="#14532d"/>
  </svg>
);
...
const HokageCloakIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="8" y="20" width="16" height="4" fill="#ef4444"/>
...
const LevitationCloakIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="6" y="6" width="20" height="4" fill="#dc2626"/>
    <rect x="6" y="6" width="20" height="1" fill="#fbbf24"/>
  </svg>
);
...
const DarkCapeIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="6" y="22" width="3" height="2" fill="#0f172a"/>
...
const SaitamaCapeIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="10" y="8" width="12" height="14" fill="#e2e8f0"/>
...
const GutsCapeIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="7" y="20" width="2" height="4" fill="#1e293b"/>
    ...
    <rect x="14" y="6" width="4" height="2" fill="#94a3b8"/>
  </svg>
);
...
const CrimsonCapeIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="22" y="6" width="4" height="4" fill="#ef4444"/>
  </svg>
);

const VampireMantleIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="6" y="6" width="20" height="18" fill="#020617"/>
    <rect x="8" y="6" width="16" height="2" fill="#9f1239"/>
...
const WinterWolfIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="8" y="10" width="16" height="14" fill="#292524"/>
    <rect x="6" y="6" width="20" height="6" fill="#94a3b8"/>
...
const OneRingIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="12" y="14" width="8" height="4" fill="#0f172a"/>
    <rect x="14" y="12" width="4" height="1" fill="#fef08a"/>
  </svg>
);
...
const MillenniumPuzzleIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="15" y="10" width="2" height="2" fill="#fef08a"/>
    <rect x="15" y="6" width="2" height="4" fill="#94a3b8"/>
  </svg>
);
...
const EyeAgamottoIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="12" y="14" width="8" height="4" fill="#1e293b"/>
    <rect x="14" y="14" width="4" height="4" fill="#22c55e"/>
    <rect x="15" y="15" width="2" height="2" fill="#86efac"/>
    <rect x="15" y="8" width="2" height="4" fill="#94a3b8"/>
  </svg>
);
...
const PhilosopherStoneIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="14" y="12" width="2" height="4" fill="#fca5a5"/>
  </svg>
);

const WolfMedallionIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="10" width="12" height="12" fill="#94a3b8"/>
    <rect x="12" y="12" width="2" height="2" fill="#dc2626"/>
    <rect x="18" y="12" width="2" height="2" fill="#dc2626"/>
    <rect x="14" y="16" width="4" height="4" fill="#475569"/>
    <rect x="12" y="8" width="2" height="2" fill="#e2e8f0"/>
    <rect x="18" y="8" width="2" height="2" fill="#e2e8f0"/>
  </svg>
);

const MaraAmuletIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="12" y="10" width="8" height="12" fill="#fbbf24"/>
    <rect x="14" y="12" width="4" height="8" fill="#0d9488"/>
    <rect x="15" y="14" width="2" height="2" fill="#5eead4"/>
  </svg>
);
...
const BehelitIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="12" y="10" width="8" height="12" fill="#b91c1c"/>
    <rect x="13" y="12" width="2" height="2" fill="#0f172a"/>
    <rect x="17" y="16" width="2" height="2" fill="#0f172a"/>
    <rect x="14" y="18" width="2" height="2" fill="#0f172a"/>
  </svg>
);
...
const CoreDrillIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="14" y="12" width="4" height="2" fill="#22c55e"/>
  </svg>
);
...
const TriforceIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="10" y="16" width="4" height="4" fill="#fbbf24"/>
    <rect x="18" y="16" width="4" height="4" fill="#fbbf24"/>
  </svg>
);

const MithrilIngotIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="14" width="12" height="8" fill="#94a3b8"/>
    <rect x="12" y="12" width="8" height="2" fill="#cbd5e1"/>
    <rect x="12" y="14" width="8" height="2" fill="#f8fafc"/>
    <rect x="8" y="20" width="16" height="2" fill="#475569"/>
  </svg>
);

const BeskarIngotIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="12" width="12" height="10" fill="#334155"/>
    <rect x="11" y="14" width="10" height="1" fill="#1e293b"/>
    <rect x="11" y="16" width="10" height="1" fill="#0f172a"/>
    <rect x="11" y="18" width="10" height="1" fill="#1e293b"/>
    <rect x="10" y="22" width="12" height="2" fill="#0f172a"/>
  </svg>
);

const VibraniumOreIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="12" width="12" height="10" fill="#1e1b4b"/>
    <rect x="12" y="10" width="6" height="2" fill="#1e1b4b"/>
    <rect x="13" y="14" width="2" height="4" fill="#a855f7"/>
    <rect x="16" y="16" width="4" height="2" fill="#a855f7"/>
    <rect x="14" y="15" width="2" height="2" fill="#d946ef"/>
  </svg>
);

const SenzuBeanIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="12" y="14" width="8" height="8" fill="#b45309"/>
    <rect x="14" y="10" width="4" height="4" fill="#78350f"/>
    <rect x="10" y="20" width="12" height="2" fill="#78350f"/>
    <rect x="14" y="16" width="4" height="2" fill="#4ade80"/>
    <rect x="13" y="12" width="6" height="2" fill="#fbbf24"/>
  </svg>
);

const SlimeJellyIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="10" y="16" width="12" height="6" fill="#38bdf8"/>
    <rect x="12" y="12" width="8" height="4" fill="#38bdf8"/>
    <rect x="14" y="10" width="4" height="2" fill="#38bdf8"/>
    <rect x="12" y="14" width="2" height="2" fill="#bae6fd"/>
  </svg>
);
...
const DragonScaleIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    ...
    <rect x="12" y="12" width="8" height="8" fill="#b91c1c"/>
    <rect x="14" y="20" width="4" height="4" fill="#991b1b"/>
    <rect x="16" y="12" width="2" height="8" fill="#fca5a5" opacity="0.3"/>
    <rect x="10" y="14" width="12" height="2" fill="#7f1d1d"/>
...
const DemonHornIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="12" y="20" width="6" height="4" fill="#dc2626"/>
    <rect x="12" y="16" width="4" height="4" fill="#1e293b"/>
    <rect x="14" y="12" width="4" height="4" fill="#1e293b"/>
    <rect x="16" y="8" width="2" height="4" fill="#0f172a"/>
    <rect x="12" y="22" width="6" height="1" fill="#7f1d1d"/>
  </svg>
);

const KryptoniteIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="14" y="8" width="4" height="16" fill="#22c55e"/>
    <rect x="12" y="12" width="2" height="10" fill="#16a34a"/>
    <rect x="18" y="14" width="2" height="8" fill="#16a34a"/>
    <rect x="15" y="10" width="2" height="12" fill="#86efac"/>
...
const StarFragmentIcon = () => (
  <svg viewBox="0 0 32 32" width="56" height="56" xmlns="http://www.w3.org/2000/svg" style={{ imageRendering: 'pixelated' }}>
    <rect x="14" y="10" width="4" height="12" fill="#fef08a"/>
    <rect x="10" y="14" width="12" height="4" fill="#fef08a"/>
    <rect x="12" y="12" width="8" height="8" fill="#fde047"/>
    <rect x="14" y="14" width="4" height="4" fill="#ca8a04"/>
    ...
    <div className="mt-8 border-t-2 border-zinc-700 pt-6" style={{ fontFamily: "'Courier New', monospace" }}>
        ...
        {slots.map((slot) => {
          ...
          return (
            ...
            >
              {item ? (
                <>
                  <span className="absolute top-1 right-1 text-[9px] text-red-400 opacity-0 group-hover:opacity-100 z-10">✕</span>
                  <div style={{ imageRendering: 'pixelated', transform: 'scale(1.0)' }}>
                    {item.icon}
                  </div>
                  <span className={`text-[11px] font-bold mt-1.5 ${rs!.labelClass} text-center leading-tight px-1`}>
                ...
                <>
                  ...
                  <span className="text-[9px] text-zinc-500 text-center">{SLOT_LABELS[slot]}</span>
                </>
              )}
            </div>
          );
      ...
      {equippedList.length > 0 && (
        <div className="p-4 bg-zinc-900 border-2 border-zinc-700">
          <p className="text-[10px] text-zinc-500 uppercase tracking-widest mb-2">{t.activeBonus}</p>
          {equippedList.map((item) => (
            <p key={item.id} className="text-[11px] text-emerald-400 leading-relaxed">
              + {item.stat}
            </p>
          ))}
        </div>
...
export default function ShopBoard({ searchQuery = "", activeCategory = "all" }: ShopBoardProps) {
  const { stats, inventory, equippedItems, buyItem, equipItem, unequipItem } = useStore();
  const { settings } = useStore();
  const t = translations[settings?.language || 'id']?.shop || translations['id'].shop;
  const tPage = translations[settings?.language || 'id']?.page || translations['id'].page;
  ...
  return (
    <div className="p-6" style={{ fontFamily: "'Courier New', monospace" }}>
      ...
      {selectedItem && (() => {
        ...
        } else if (stats.gold < item.price) {
          actionLabel = "GOLD KURANG";
            ...
            <div className={`w-full max-w-sm bg-zinc-900 border-4 ${rs.border} shadow-[8px_8px_0_rgba(0,0,0,0.7)] flex flex-col overflow-hidden`}>
              ...
              <div className="p-5 flex flex-col items-center text-center flex-1">
                ...
                <div className="w-full bg-zinc-950/50 border border-zinc-800/80 p-3 mb-4 font-mono">
                  ...
                  <p className="text-[9px] text-zinc-500 mt-2 uppercase tracking-wider">
                    {t.slot || 'SLOT'}: {categories.find(c => c.id === item.slot)?.label || item.slot}
                  </p>
                </div>
              ...
              <div className="grid grid-cols-2 gap-2 p-3 bg-zinc-950 border-t-2 border-zinc-800">
                <button
                  ...
                  className="px-4 py-2.5 bg-zinc-800 border-2 border-zinc-600 hover:border-zinc-400 text-zinc-300 font-bold text-xs tracking-widest uppercase transition-all shadow-[2px_2px_0_#000] active:translate-y-0.5 active:shadow-none"
                >
                  BATAL
                </button>
                <button
                  ...
                  className={`px-4 py-2.5 font-bold text-xs tracking-widest uppercase transition-all shadow-[2px_2px_0_#000] active:translate-y-0.5 active:shadow-none
                    ${isActionDisabled 
                      ? 'bg-zinc-700 border-2 border-zinc-600 text-zinc-500 cursor-not-allowed shadow-none transform-none' 
                      : isEquipped 
                        ? 'bg-red-600 border-2 border-red-400 text-white hover:bg-red-500 shadow-red-900/50' 
                        : ownedCount > 0 
                          ? 'bg-emerald-600 border-2 border-emerald-400 text-white hover:bg-emerald-500 shadow-emerald-900/50'
                          : 'bg-cyan-500 border-2 border-cyan-300 text-zinc-950 hover:bg-cyan-400 shadow-cyan-900/50'
                    }`}
                >
                  {actionLabel}
                </button>
        ...
        {ITEMS.filter(item => {
          ...
          return (
            <button
              ...
              style={{ imageRendering: 'pixelated' }}
              className={`
                relative flex flex-col w-full aspect-[3/4] min-h-[280px] bg-zinc-900 border-2 overflow-hidden
            ...
            >
              ...
              >
                ...
                >
                  <div
                    style={{
                      transform: isHovered ? 'scale(1.5)' : 'scale(1.4)',
                      transition: 'transform 0.15s cubic-bezier(0.4, 0, 0.2, 1)',
                    }}
                    className="flex items-center justify-center [&>svg]:w-16 [&>svg]:h-16" 
                  >
                    {item.icon}
                  </div>
                </div>
              ...
              {isHovered && (
                ...
                >
                  <div className="text-center w-full px-1">
                    {item.stat.split('/').map((s, i) => (
                      <p key={i} className="text-[10px] font-bold text-emerald-400 font-mono leading-relaxed mb-0.5">{s.trim()}</p>
                    ))}
                  </div>
                  <p className="text-[8px] text-zinc-500 font-mono mt-1.5 uppercase tracking-wider">
                    {t.slot}: {categories.find(c => c.id === item.slot)?.label || item.slot}
                  </p>
                  <p className="text-[10px] font-bold mt-4 text-amber-400 border border-amber-500/30 bg-amber-500/5 px-2 py-1 tracking-wider font-mono">
                    LIHAT DETAIL
                  </p>
                </div>
              )}
              ...
              <div className="bg-zinc-950 border-t border-zinc-800/80 py-2.5 flex items-center justify-center gap-2 shrink-0">
                <div
                  ...
                  style={{ clipPath: 'polygon(50% 0%,100% 25%,100% 75%,50% 100%,0% 75%,0% 25%)' }}
                />
                <span className="font-bold text-amber-400 text-[10px] tracking-widest font-mono">{item.price} G</span>
              </div>
            </button>
          );
        })}
