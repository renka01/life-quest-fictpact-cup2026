...
export default function StatusPanel() {
  ...
  return (
    <aside className="w-80 bg-[#1a1b26] border-l-4 border-slate-700 p-6 flex flex-col gap-6 z-10 shadow-[-4px_0_0_rgba(0,0,0,0.5)] overflow-y-auto shrink-0">
      ...
      <div className="bg-[#24283b] p-3 rounded-none border-4 border-slate-700 shadow-[8px_8px_0_#000] relative flex flex-col gap-4">
