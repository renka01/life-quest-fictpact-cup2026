          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5">
            ...
            <button type="button" onClick={() => {
              useStore.setState({
                userProfile: { accountName: "", nickname: "", gender: null, avatarId: null, level: 1, gold: 0, exp: 0 },
                dailyProgress: { loginClaimed: false, tasksCompleted: 0, taskClaimed: false, bossesDefeated: 0, bossClaimed: false },
                inventory: [], equippedItems: {}, tasks: [], accounts: [], transactions: [], recurringTransactions: [],
                stats: { level: 1, hp: 50, maxHp: 50, exp: 0, maxExp: 300, gold: 0, streak: 0, lastLoginDate: "" }, activeFocusSession: { isActive: false, bossId: null, duration: 0, endTime: 0 }, hasLoadedFromCloud: false
              });
              signIn('google', { callbackUrl: '/' });
            }} className="flex-1 py-3.5 bg-zinc-900 hover:bg-zinc-800 border-2 border-zinc-950 text-zinc-300 font-bold rounded-2xl flex items-center justify-center gap-2 transition-colors border-b-[4px] hover:border-b-[2px] hover:translate-y-[2px] active:border-b-0 active:translate-y-[4px]">
